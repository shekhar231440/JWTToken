 ...
 * 
 * import com.security.auth.service.UserService; import
 * com.security.auth.utility.JWTUtility;
 * 
 ...
 * filterChain) throws ServletException, IOException { String authorization =
 * httpServletRequest.getHeader("Authorization"); String token = null; String
 * userName = null;
 * 
